  ...
  <div className="container">
    ...
    <div className="row justify-content-center mb-4">
      <div className="col-md-7 text-center">
        ...
        <h6 className="subtitle">Meet our team of innovative engineers who will guide you through your education journey and amplify your impact on your students.</h6>
      </div>
    </div>
    <div className="row">
      ...
      <div className="col-lg-2 mb-4">
        ...
        <div className="row">
          ...
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Allie Do</h5>
      ...
      <div className="col-lg-2 mb-4">
        ...
        <div className="row">
          <div className="col-md-12">
            <img src="./images/lia.jpeg" alt="wrapkit" className="img-fluid rounded-circle" />
          </div>
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Lia Fredericks</h5>
              <h6 className="subtitle mb-3">Frontend Developer</h6>
              <p></p>
              <ul className="list-inline">
                <li className="list-inline-item"><a href="#" className="text-decoration-none d-block px-1"><i className="icon-social-facebook"></i></a></li>
      ...
      <div className="col-lg-2 mb-4">
        ...
        <div className="row">
          <div className="col-md-12">
            <img src="./images/carter.jpg" alt="wrapkit" className="img-fluid rounded-circle" />
          </div>
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Carter Knight</h5>
              <h6 className="subtitle mb-3">Scrum Master</h6>
              <p></p>
              <ul className="list-inline">
                <li className="list-inline-item"><a href="#" className="text-decoration-none d-block px-1"><i className="icon-social-facebook"></i></a></li>
                <li className="list-inline-item"><a href="#" className="text-decoration-none d-block px-1"><i className="icon-social-twitter"></i></a></li>
      ...
      <div className="col-lg-2 mb-4">
        <div className="row">
          <div className="col-md-12">
            <img src="./images/sam.jpeg" alt="wrapkit" className="img-fluid rounded-circle" />
          </div>
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Sampriti Panda</h5>
      ...
      <div className="col-lg-2 mb-4">
        ...
        <div className="row">
          <div className="col-md-12">
            <img src="./images/alia.jpeg" alt="wrapkit" className="img-fluid rounded-circle" />
          </div>
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Alia Yeszhanova</h5>
              <h6 className="subtitle mb-3">Frontend Developer</h6>
              <p></p>
              <ul className="list-inline">
                <li className="list-inline-item"><a href="#" className="text-decoration-none d-block px-1"><i className="icon-social-facebook"></i></a></li>
      ...
      <div className="col-lg-2 mb-4">
        ...
        <div className="row">
          ...
          <div className="col-md-12 text-center">
            <div className="pt-2">
              <h5 className="mt-4 font-weight-medium mb-0">Victoria Young</h5>
              <h6 className="subtitle mb-3">Backend Developer</h6>
              <p></p>
              <ul className="list-inline">
                <li className="list-inline-item"><a href="#" className="text-decoration-none d-block px-1"><i className="icon-social-facebook"></i></a></li>
